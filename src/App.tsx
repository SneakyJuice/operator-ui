...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#0d0d0d]">
      {/* Top bar */}
      <header className="flex items-center justify-between px-4 h-10 bg-[#0a0a0a] border-b border-[#1a1a1a] shrink-0 z-10">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="flex-1 min-w-0 overflow-hidden bg-[#0d0d0d]">
          {renderMain()}
        </main>
